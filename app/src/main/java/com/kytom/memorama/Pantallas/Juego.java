...
public class Juego extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //verificamos el nivel seleccionado, para mostrar la pantalla correspondiente
        if(nivel==1 || nivel==4) {
        ...
        //generamos un numero aleatorio para los nombres para la posicion de los nombres
    ...
    //acomodamos las imagenes y en cada partida se generan de manera aleatoria
    ...
    //le damos imagen diferente a cada una de las cartas y le permitimos voltearlas
    ...
    //verificamos si las parejas volteadas son iguales o no,asi mismo sumamos puntos o sedemos turno
...
//verificamos si las cartas son iguales o no y asi mismo generamos un sonido para cada situacion
    ...
    //manejamos los turnos y cuando es temporizado o no y si lo es entonces pausamos el cronometro de cada uno cuando no sea su turno
    ...
    //cuando el juego es temporizado entonces realizamos una cuenta regresiva del tiempo que la persona quiere jugar y le damos una orden al acabarse este tiempo
